...
// if (e instanceof NoSuchElementException || e instanceof
...
// var fieldError = ((MethodArgumentNotValidException)
// e).getBindingResult().getFieldError();
// fieldError.getField();
// fieldError.getDefaultMessage();
// var message = ("[" + fieldError.getField() + "] " +
// fieldError.getDefaultMessage()).toLowerCase();
// return responseComponent.generate(StatusEnumeration.F2,
// HttpStatus.BAD_REQUEST, message);
// } else if (e instanceof HttpRequestMethodNotSupportedException) {
// var message = e.getMessage().toLowerCase();
// return responseComponent.generate(StatusEnumeration.F3,
// HttpStatus.BAD_REQUEST, message);
// }
